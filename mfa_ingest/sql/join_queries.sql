...
SELECT
    ...
    /* ---------- collection_flow_kpi ---------- */
    cfk.purity_amount                            AS coll_flow_purity_amount,
    cfk.purity_unit                              AS coll_flow_purity_unit,
    cfk.attached_moisture_and_dirt_amount_value  AS coll_flow_attached_moisture_value,
    cfk.attached_moisture_and_dirt_amount_unit   AS coll_flow_attached_moisture_unit,
    cfk.npp_share_amount_value                   AS coll_flow_npp_share_value,
    cfk.npp_share_amount_unit                    AS coll_flow_npp_share_unit,
    cfk.residual_waste_share_amount_value        AS coll_flow_residual_share_value,
    cfk.residual_waste_share_amount_unit         AS coll_flow_residual_share_unit,
    cfk.eps_items_amount_value                   AS coll_flow_eps_items_value,
    cfk.eps_items_amount_unit                    AS coll_flow_eps_items_unit,

    /* ---------- sorting_flow_kpi ---------- */
    sfk.maximum_total_amount_of_impurities_amount AS sort_flow_max_impurities_amount,
    sfk.maximum_total_amount_of_impurities_unit   AS sort_flow_max_impurities_unit,
    sfk.purity_amount                             AS sort_flow_purity_amount,
    sfk.purity_unit                               AS sort_flow_purity_unit,
    sfk.other_metal_items_amount                  AS sort_flow_other_metal_amount,
    sfk.other_metal_items_unit                    AS sort_flow_other_metal_unit,
    sfk.other_plastics_items_amount               AS sort_flow_other_plastics_amount,
    sfk.other_plastics_items_unit                 AS sort_flow_other_plastics_unit,
    sfk.ppk_amount                                AS sort_flow_ppk_amount,
    sfk.ppk_unit                                  AS sort_flow_ppk_unit,
    sfk.eps_items_amount                          AS sort_flow_eps_items_amount,
    sfk.eps_items_unit                            AS sort_flow_eps_items_unit,
    sfk.pvc_items_amount                          AS sort_flow_pvc_items_amount,
    sfk.pvc_items_unit                            AS sort_flow_pvc_items_unit,
    sfk.colourless_transparent_foils_amount       AS sort_flow_ct_foils_amount,
    sfk.colourless_transparent_foils_unit         AS sort_flow_ct_foils_unit,
    sfk.yield_of_ds_from_input_amount             AS sort_flow_yield_ds_from_input_amount,
    sfk.yield_of_ds_from_input_unit               AS sort_flow_yield_ds_from_input_unit,

    /* ---------- recycling_flow_kpi ---------- */
    rfk.filtration_amount                         AS rec_flow_filtration_amount,
    rfk.filtration_unit                           AS rec_flow_filtration_unit,
    rfk.recyclate_polymer_purity_amount           AS rec_flow_polymer_purity_amount,
    rfk.recyclate_polymer_purity_unit             AS rec_flow_polyler_purity_unit,
    rfk.pcr_content_amount                        AS rec_flow_pcr_content_amount,
    rfk.pcr_content_unit                          AS rec_flow_pcr_content_unit,
    rfk.melt_flow_rate_amount                     AS rec_flow_mfr_amount,
    rfk.melt_flow_rate_unit                       AS rec_flow_mfr_unit,
    rfk.ash_content_amount                        AS rec_flow_ash_content_amount,
    rfk.ash_content_unit                          AS rec_flow_ash_content_unit,
    rfk.tensile_modulus_amount                    AS rec_flow_tensile_modulus_amount,
    rfk.tensile_modulus_unit                      AS rec_flow_tensile_modulus_unit,
    rfk.tensile_strength_amount                   AS rec_flow_tensile_strength_amount,
    rfk.tensile_strength_unit                     AS rec_flow_tensile_strength_unit,
    rfk.chapry_notch_impact_strength_amount       AS rec_flow_charpy_notch_amount,
    rfk.chapry_notch_impact_strength_unit         AS rec_flow_charpy_notch_unit,
    rfk.yield_flow_sample_amount                  AS rec_flow_yield_sample_amount,
    rfk.yield_flow_sample_unit                    AS rec_flow_yield_sample_unit,
